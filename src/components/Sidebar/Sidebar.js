...
const Sidebar = () => {
  ...
  const {checkValueExists,clickedItem,clickHandler,modeToggler } = useContext(AuthContext);
        ...
        <div className={status? "sidebarContainer" : "sidebarContainer hidden"}>
          <div className="top">
            ...
            <ul className="categories">
              {itemInFocus && boardData.map((cat, index) => {
          ...
          <div className="bottom">
            <div className={status && "top-icon-bar"} onChange={() => modeToggler()}>
              <img src={sun} alt="" />
